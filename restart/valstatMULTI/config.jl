...
mdict=[
  ...
  [
    1,
    "erme1",               # szabályos érmével 1-el tobb fejet kapunk mint irast
    "erme2"                # több fej mint írás (páros sok érme)
  ],  
  [
    1,
  ...
  [
    1,
    "szorzat",              # A,B-ből számokat választva mekkora esállyel lesz a szorzat pozitív? (kfokú. érettségi)
  ...
  [
    1,
    "selejt",                # teljes valség-Bayes   
    "tanul",                 # ua.
  ],  
  [
    1,
    "ital",                 # kombinatorika,egyszerű variáció
    "vezetoseg",            # variáció
  ],
  [
    1,
    "utest",                # ketoldali u-próba
    "ttest",                 # ketoldali t-próba
  ]
]
