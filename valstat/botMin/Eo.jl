let
   ...
   jv=replace(raw"$F(x)=\frac{x}{__H2},\:\: 0<x<__H2$","__H2"=>toS(h2))
   rv1=replace(raw"$F(x)=\frac{x}{__H},\:\: 0<x<__H$","__H"=>toS(h))
   rv2=replace(raw"$F(x)=\frac{x}{__H},\:\: __H2<x<__H$",[
   "__H2",toS(h2),"__H",toS(h)]);
   rv3=replace(raw"$F(x)=\frac{x}{__H2},\:\: __H2<x<__H$",[
   "__H2",toS(h2),"__H",toS(h)]);
